(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-hero__body")) new Swiper(".slider-hero__body", {
            ...
            on: {
                init: function() {
                    ...
                    document.querySelector(".controls-slider__value").innerHTML = `\n\t\t\t\t\t<span class="controls-slider__current">\n\t\t\t\t\t${currentSlide < 10 ? "0" + currentSlide : currentSlide}\n\t\t\t\t\t</span> \n\t\t\t\t\t|\n\t\t\t\t\t<span class="controls-slider__total">\n\t\t\t\t\t\t${this.slides.length < 10 ? "0" + this.slides.length : this.slides.length}\n\t\t\t\t\t</span>`;
                },
        ...
        if (document.querySelector(".slider-video__body")) new Swiper(".slider-video__body", {
            ...
            loop: true,
            pagination: {
                el: ".slider-video__dotts",
                clickable: true
            },
            navigation: {
                prevEl: ".slider-video__arrow-prev",
                nextEl: ".slider-video__arrow-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 2,
    ...
    mapboxgl.accessToken = "pk.eyJ1IjoieWt1bGlrayIsImEiOiJjbTE2OWlyNTgwaHg4MndzYm80cm1xbnk0In0.rTpel-XmBDV0R6ACdPb4aw";
    const map = new mapboxgl.Map({
        container: "map",
        style: "mapbox://styles/ykulikk/cm195vwgb02by01qy0tkxhf92",
        projection: "globe",
        zoom: 15.8,
